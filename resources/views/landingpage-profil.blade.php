      ...
      <div class="row">
        ...
        <div class="col-lg-6 d-flex flex-column justify-contents-center" data-aos="fade-right">
          <div class="content pt-4 pt-lg-0">
            <h3 style="color: green;font-weight:bold">PROFIL</h3>
            ...
            <h4 style="color: green; text-align:justify;font-family: 'Times New Roman', Times, serif;font-size:large ">
              ...
              <p>
                PT. Yafo Agro Indonesia adalah perusahaan agribisnis yang berkomitmen
                pada praktik ekonomi hijau Menyediakan produk dan jasa agrikultur yang
                berkualitas dan berkelanjutan, untuk menciptakan nilai tambah kepada
                seluruh pemangku kepentingan.
                PT. YAFO AGRO INDONESIA
                Pandang Dalam sektor pertanian,
                PT. Yafo Agro Indonesia terlibat dalam berbagai praktik berkelanjutan
                seperti pertanian organik, penggunaan pupuk organik, dan pengelolaan
        ...
        <div class="col-lg-6 rounded">
          <center>
            <img src="{{url('public/logo')}}/LOGO YAFO hijau.png" alt="" width="50%" height="100%">
